...
export default function Sidebar() {
	...
	return (
		<aside className="fixed bottom-0 left-0 top-0 w-48 border-r border-accent-light bg-secondary-light p-4 pt-24 dark:border-accent-dark dark:bg-secondary-dark">
